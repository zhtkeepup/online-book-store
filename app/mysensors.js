...
export function sensorsLogin(userId) {
    sensors.login(userId);
}

export function sensorsTract(event, props) {
    console.log("sensors.track:", event, props);
    sensors.track(event, props)
}


export function sensorsSetKey(keyName, keyValue){
